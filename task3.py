...
def filter_logs_by_level(logs: List[Dict[str, str]], level: str) -> List[Dict[str, str]]:
    ...
    Args:
        logs: Список логів
        level: Рівень логування для фільтрації (INFO, ERROR, DEBUG, WARNING)
        
    Returns:
        list: Відфільтровані логи
    """
    # Використовуємо функцію filter та лямбда-функцію (елемент функціонального програмування)
...
def display_log_counts(counts: Dict[str, int]) -> None:
    ...
    # Сортуємо рівні для красивого виведення
